...
# es un test que he intentado hacer para comprobar que el bot recupera correctamente de la base de datos
...
# 'pytest discord_failed_t.py' se le puede añadir -s para más información
...
# la idea inicial fue pasarle el parámetro voting y tener ahí la votación, pero uno se ejecuta con los
# test de django y otro con pytest, no son compatibles
